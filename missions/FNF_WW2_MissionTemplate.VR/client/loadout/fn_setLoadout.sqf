...
if (_pClass == UNIT_OPFOR_GR || _pClass == UNIT_BLUFOR_GR || _pClass == UNIT_INDFOR_GR) then {pRole = ROLE_GR};
...
switch (pRole) do {
  ...
  case ROLE_GR: {call compile preprocessFileLineNumbers format["client\loadout\units\GR.sqf"]};
};
