...
if (pRole == ROLE_PL || pRole == ROLE_SL) then {
  ...
  phx_loadout_vest = "V_LIB_US_Vest_Thompson_nco_Radio";
};
...
if (pRole == ROLE_MG) then {phx_loadout_vest = "V_LIB_US_Vest_M1919"};

if (pRole == ROLE_AAR || pRole == ROLE_R) then {phx_loadout_vest = "V_LIB_US_Vest_Garand"};

if (pRole == ROLE_CLS) then {phx_loadout_vest = "V_LIB_US_Vest_Medic2"; phx_loadout_headgear = "H_LIB_US_Helmet_Med"; phx_loadout_uniform = "U_LIB_US_Rangers_Med"};
