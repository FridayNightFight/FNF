...
[phx_loadout_mediumantitank_mag, "backpack"] call phx_fnc_handleGear;
player addWeapon phx_loadout_mediumantitank_weapon;
[phx_loadout_mediumantitank_mag_1, "backpack"] call phx_fnc_handleGear;
player addSecondaryWeaponItem phx_loadout_mediumantitank_optic;
[phx_loadout_sidearm_mag, "uniform"] call phx_fnc_handleGear;
