...
phx_loadout_uniform  = "U_mas_chi_O_sf1";
phx_loadout_vest     = "V_mas_chi_PlateCarrier_sf";
phx_loadout_backpack = "B_FieldPack_oli";
phx_loadout_headgear = "H_mas_chi_HelmetO_SF";


if (pRole == ROLE_PL) then { phx_loadout_uniform = "U_mas_chi_O_officer3";};
