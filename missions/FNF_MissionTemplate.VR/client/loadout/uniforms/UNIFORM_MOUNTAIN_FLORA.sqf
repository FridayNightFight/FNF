...
phx_loadout_vest = "rhs_6sh92_vsr";
phx_loadout_headgear = "rhs_6b28_green";

if (pRole == ROLE_PL || pRole == ROLE_SL || pRole == ROLE_TL || pRole == ROLE_MGTL) then {phx_loadout_vest = "rhs_6sh92_vsr_headset";}; //PL, SL, TL, MGTL
...
if (pRole == ROLE_P) then {
  ...
  phx_loadout_vest = "rhs_6sh92_vsr_radio";
