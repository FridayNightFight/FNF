...
phx_loadout_uniform  = "U_mas_chi_O_soldw";
phx_loadout_vest     = "V_mas_chi_PlateCarrier_w";
phx_loadout_backpack = "O_mas_chi_Kitbag_w";
phx_loadout_headgear = "H_mas_chi_HelmetOW_gog";
