...
switch (pRole) do {
    ...
    case ROLE_PL: {
        [] call compile preprocessFileLineNumbers format["client\loadout\units\PL.sqf"]
    };
    case ROLE_AR: {
        [] call compile preprocessFileLineNumbers format["client\loadout\units\AR.sqf"]
    };
    case ROLE_CLS: {
        [] call compile preprocessFileLineNumbers format["client\loadout\units\CLS.sqf"]
    };
    case ROLE_AAR: {
        [] call compile preprocessFileLineNumbers format["client\loadout\units\AAR.sqf"]
    };
    case ROLE_SL: {
        [] call compile preprocessFileLineNumbers format["client\loadout\units\SL.sqf"]
    };
    case ROLE_R: {
        [] call compile preprocessFileLineNumbers format["client\loadout\units\R.sqf"]
    };
    case ROLE_TL: {
        [] call compile preprocessFileLineNumbers format["client\loadout\units\TL.sqf"]
    };
    case ROLE_CE: {
        [] call compile preprocessFileLineNumbers format["client\loadout\units\CE.sqf"]
    };
    case ROLE_MG: {
        [] call compile preprocessFileLineNumbers format["client\loadout\units\MG.sqf"]
    };
    case ROLE_RAT: {
        [] call compile preprocessFileLineNumbers format["client\loadout\units\RAT.sqf"]
    };
    case ROLE_AM: {
        [] call compile preprocessFileLineNumbers format["client\loadout\units\AM.sqf"]
    };
    case ROLE_MGTL: {
        [] call compile preprocessFileLineNumbers format["client\loadout\units\MGTL.sqf"]
    };
    case ROLE_AT: {
        [] call compile preprocessFileLineNumbers format["client\loadout\units\AT.sqf"]
    };
    case ROLE_AAT: {
        [] call compile preprocessFileLineNumbers format["client\loadout\units\AAT.sqf"]
    };
    case ROLE_P: {
        [] call compile preprocessFileLineNumbers format["client\loadout\units\P.sqf"]
    };
    case ROLE_CR: {
      [] call compile preprocessFileLineNumbers format["client\loadout\units\CR.sqf"]
    };
    case ROLE_MK: {
      [] call compile preprocessFileLineNumbers format["client\loadout\units\MK.sqf"]
    };
