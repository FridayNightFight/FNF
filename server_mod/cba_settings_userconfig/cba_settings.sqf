...
force force ace_refuel_cargoRate = 1;
...
force force ace_repair_patchWheelMaximumRepair = 0.75;
...
force force grad_trenches_functions_allowTextureLock = false;
...
force force grad_trenches_functions_bigEnvelopeDigTime = 75;
...
force force IFX_ACE3WindowBreak_setting_audibleDistance = 5;
...
force force TFAR_externalIntercomEnable = 1;
