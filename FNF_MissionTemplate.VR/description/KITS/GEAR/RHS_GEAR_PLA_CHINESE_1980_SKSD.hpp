...
#define RIFLE "uk3cb_sks_02"
// put all mags for the weapons above -- only the compatible ones for the player's weapon will be given
#define RIFLE_MAG "rhs_30Rnd_762x39mm_89:7","rhs_30Rnd_762x39mm_tracer:4"
// give Riflemen extra mags
#define RIFLE_MAG_RI "rhs_30Rnd_762x39mm_89:12","rhs_30Rnd_762x39mm_tracer:6"
...
class RHS_GEAR_PLA_CHINESE_1980_SKSD {
  author = "Mazz38";
  description = "CN: 1980 CHINESE PLA SKSD Kits";
