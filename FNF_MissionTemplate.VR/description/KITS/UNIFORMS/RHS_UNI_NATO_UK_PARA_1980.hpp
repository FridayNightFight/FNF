...
#define UNIFORM "rhsgref_uniform_dpm", "rhsgref_uniform_dpm_olive"
...
class RHS_UNI_NATO_UK_PARA_1980 {
  author = "Mazz38";
  description = "United Kingdom: 1980s British PARA DPM Camouflage";
