...
#define UNIFORM "vn_b_uniform_macv_01_18", "vn_b_uniform_macv_02_18", "vn_b_uniform_macv_04_18", "vn_b_uniform_macv_06_18"
...
class VN_UNI_ROK {
  author = "Mazz38";
  description = "ROK: Vietnam Era Republic Of Korea";
