...
#define UNIFORM "UK3CB_CW_US_B_Early_U_CombatUniform_01_OLI"
...
#define HELMET "rhsgref_helmet_M1_mit"
...
class RHS_UNI_NATO_CANADIAN_ARMY_1980 {
  author = "Mazz38";
  description = "CA: 1980s Canadian ARMY Olive Camouflage";
