...
_vehicle setPylonLoadout ["cmDispenser", "rhs_ASO2_CMFlare_Chaff_Magazine_x4", true, [-1]];
_vehicle setAmmoOnPylon ["cmDispenser", 64];

_vehicle addWeaponTurret["rhs_weap_MASTERSAFE",[0]];

_vehicle addWeaponTurret["rhs_weap_yakB",[0]];
_vehicle addMagazineTurret["rhs_mag_127x108mm_1slt_1470", [0], 1470];
