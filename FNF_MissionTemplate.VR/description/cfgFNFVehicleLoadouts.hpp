...
class UK3CB_AAV {
  class FNF_SetLoadout {
    serverInit = "_this call fnf_vehicleLoadouts_fnc_AAV";
  };
};
// BMP-1
class UK3CB_BMP1Tank_Base {
  class FNF_SetLoadout {
    serverInit = "_this call fnf_vehicleLoadouts_fnc_BMP1";
  };
};
// BMP-2
class UK3CB_BMP2Tank_Base {
  class FNF_SetLoadout {
    serverInit = "_this call fnf_vehicleLoadouts_fnc_BMP2";
  };
};
// LAV-25
...
// LAV-C2
class UK3CB_LAV25_HQ {
  class FNF_SetLoadout {
    serverInit = "_this call fnf_vehicleLoadouts_fnc_LAVC2";
  };
};
// FV-510
class UK3CB_Warrior_Base {
  class FNF_SetLoadout {
    serverInit = "_this call fnf_vehicleLoadouts_fnc_FV510";
  };
};
