...
_getVehicleData = {
  ...
  switch (true) do {
    case (_x inArea "bluforSafeMarker"): {
      phx_ui_structTextRef_AssetsBLU pushBackUnique [
    ...
    case (_x inArea "opforSafeMarker"): {
      phx_ui_structTextRef_AssetsOPF pushBackUnique [
        format["%1x %2",_typeCount, _dispName],
        _outArr joinString "<br/>"
      ];
      exit;
    ...
    case (_x inArea "indforSafeMarker"): {
      phx_ui_structTextRef_AssetsIND pushBackUnique [
        format["%1x %2",_typeCount, _dispName],
        _outArr joinString "<br/>"
      ];
      exit;
    ...
    default {
      phx_ui_structTextRef_AssetsOther pushBackUnique [
        format["%1x %2",_typeCount, _dispName],
        _outArr joinString "<br/>"
      ];
    };
