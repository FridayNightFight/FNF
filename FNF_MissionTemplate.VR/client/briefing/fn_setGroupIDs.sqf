...
_groups = [
    ...
    ["Blue_PR","X","X-Ray (Recon)",1, [8, 2, [0, 1, 2, 3, 4, 5, 6, .2]] ],

    //1st Platoon
    ["Blue_PLHQ","PLHQ","Platoon HQ",2, [2, 1, [0, 1, 2, 3, 4]] ],
    ...
    ["Red_PR","X","X-Ray (Recon)",1, [8, 2, [0, 1, 2, 3, 4, 5, 6, .2]] ],

    //1st Platoon
    ["Red_PLHQ","PLHQ","Platoon HQ",2, [2, 1, [0, 1, 2, 3, 4]] ],
    ...
    ["Red_D","D","Delta Squad",1, [2, 1, [1, 6, 6.1, 6.2]] ],
    ["Red_D1","D1","Delta One",0, [2, 1, [6, 6.1, 6.2]] ],
    ["Red_D2","D2","Delta Two",0, [3, 1, [6, 6.1, 6.2]] ],

    ["Red_E","E","Echo Squad",1, [2, 1, [1, 7, 7.1, 7.2]] ],
    ["Red_E1","E1","Echo One",0, [2, 1, [7, 7.1, 7.2]] ],
    ["Red_E2","E2","Echo Two",0, [3, 1, [7, 7.1, 7.2]] ],

    ["Red_F","F","Foxtrot Squad",1, [2, 1, [1, 8, 8.1, 8.2]] ],
    ["Red_F1","F1","Foxtrot One",0, [2, 1, [8, 8.1, 8.2]] ],
    ["Red_F2","F2","Foxtrot Two",0, [3, 1, [8, 8.1, 8.2]] ],

    //Vehicle teams - under Company freq
    //["Red_G","G","Golf Squad (Vic)",1, [2, 1, [0, 9, 9.1, 9.2, 9.3, 9.4]] ],
    ["Red_G1","G1","Golf One (Vic)",0, [2, 1, [0, 9.1, 9.2, 9.3, 9.4]] ],
    ["Red_G2","G2","Golf Two (Vic)",0, [3, 1, [0, 9.1, 9.2, 9.3, 9.4]] ],
    ["Red_G3","G3","Golf Three (Vic)",0, [4, 1, [0, 9.1, 9.2, 9.3, 9.4]] ],
    ["Red_G4","G4","Golf Four (Vic)",0, [5, 1, [0, 9.1, 9.2, 9.3, 9.4]] ],

    //Pilot teams - under Company freq
    //["Red_H","H","Hotel Squad (Air)",1, [2, 1, [0, 10, 10.1, 10.2, 10.3]] ],
    ["Red_H1","H1","Hotel One (Air)",0, [2, 1, [0, 10.1, 10.2, 10.3]] ],
    ["Red_H2","H2","Hotel Two (Air)",0, [3, 1, [0, 10.1, 10.2, 10.3]] ],
    ["Red_H3","H3","Hotel Three (Air)",0, [4, 1, [0, 10.1, 10.2, 10.3]] ],

    // INDFOR
    //["Green_CC","CMD","Company Command",3, [1, 8, [0, 1, 2, 3, 4, 5, 6, .1]] ],
    ["Green_PR","X","X-Ray (Recon)",1, [8, 2, [0, 1, 2, 3, 4, 5, 6, .2]] ],

    //1st Platoon
    ["Green_PLHQ","PLHQ","Platoon HQ",2, [2, 1, [0, 1, 2, 3, 4]] ],
    ...
    ["Green_D","D","Delta Squad",1, [2, 1, [1, 6, 6.1, 6.2]] ],
    ["Green_D1","D1","Delta One",0, [2, 1, [6, 6.1, 6.2]] ],
    ["Green_D2","D2","Delta Two",0, [3, 1, [6, 6.1, 6.2]] ],

    ["Green_E","E","Echo Squad",1, [2, 1, [1, 7, 7.1, 7.2]] ],
    ["Green_E1","E1","Echo One",0, [2, 1, [7, 7.1, 7.2]] ],
    ["Green_E2","E2","Echo Two",0, [3, 1, [7, 7.1, 7.2]] ],

    ["Green_F","F","Foxtrot Squad",1, [2, 1, [1, 8, 8.1, 8.2]] ],
    ["Green_F1","F1","Foxtrot One",0, [2, 1, [8, 8.1, 8.2]] ],
    ["Green_F2","F2","Foxtrot Two",0, [3, 1, [8, 8.1, 8.2]] ],

    //Vehicle teams - under Company freq
    //["Green_G","G","Golf Squad (Vic)",1, [2, 1, [0, 9, 9.1, 9.2, 9.3, 9.4]] ],
    ["Green_G1","G1","Golf One (Vic)",0, [2, 1, [0, 9.1, 9.2, 9.3, 9.4]] ],
    ["Green_G2","G2","Golf Two (Vic)",0, [3, 1, [0, 9.1, 9.2, 9.3, 9.4]] ],
    ["Green_G3","G3","Golf Three (Vic)",0, [4, 1, [0, 9.1, 9.2, 9.3, 9.4]] ],
    ["Green_G4","G4","Golf Four (Vic)",0, [5, 1, [0, 9.1, 9.2, 9.3, 9.4]] ],

    //Pilot teams - under Company freq
    //["Green_H","H","Hotel Squad (Air)",1, [2, 1, [0, 10, 10.1, 10.2, 10.3]] ],
    ["Green_H1","H1","Hotel One (Air)",0, [2, 1, [0, 10.1, 10.2, 10.3]] ],
    ["Green_H2","H2","Hotel Two (Air)",0, [3, 1, [0, 10.1, 10.2, 10.3]] ],
    ["Green_H3","H3","Hotel Three (Air)",0, [4, 1, [0, 10.1, 10.2, 10.3]] ]
];
