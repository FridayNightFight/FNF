...
_resultReadout = (phx_adminDisplay select 0) ctrlCreate[ "ctrlStructuredText", 10020 ];
...
_banPlayerButton ctrlAddEventHandler[ "ButtonClick", {
  ...
  _background = (phx_adminDisplay select 0) ctrlCreate ["IGUIBack", 10021];
  _background ctrlSetPosition [1,0.4,0.3,0.3];
  _background ctrlSetBackgroundColor [0,0,0,0.5];
  _background ctrlCommit 0;

  _text = (phx_adminDisplay select 0) ctrlCreate ["ctrlStructuredText", 10022];
  ...
  _confirmButton = (phx_adminDisplay select 0) ctrlCreate ["ctrlButton", 10023];
  ...
  _confirmButton ctrlAddEventHandler[ "ButtonClick", {
    ...
    _background = (phx_adminDisplay select 0) displayCtrl 10021;
    _text = (phx_adminDisplay select 0) displayCtrl 10022;
    _confirmButton = (phx_adminDisplay select 0) displayCtrl 10023;
