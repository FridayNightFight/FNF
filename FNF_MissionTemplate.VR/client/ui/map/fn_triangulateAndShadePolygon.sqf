...
//list of markers to make polygon out of, RGBA values, whether to invert
...
fnf_trianglesToDraw pushBack [+_outputsToUse, [(_rgbaValues select 0),(_rgbaValues select 1),(_rgbaValues select 2),(_rgbaValues select 3)] ,"#(rgb,1,1,1)color(1,1,1,1)", _copyOfMarkerList select 0];
