class RscTitles {
  ...
  class playerNumberStructText {
    ...
    fadein = 0;
    fadeout = 0;
    name = "playerNumberStructText";
    onLoad = "uiNamespace setVariable ['playerNumberStructText', _this select 0];";
    onUnLoad = "uiNamespace setVariable ['playerNumberStructText', nil]";
    class controls {
      class structuredTextForPlayerNumber {
        access = 0;
        type = 13;
        idc = 1005;
        style = 0x00;
