...
switch (true) do {
  case (phx_addNVG isEqualTo true || playerSide isEqualTo phx_addNVG): {_hasNVG = true};
  case (typeName phx_addNVG == "ARRAY"): {if (playerSide in phx_addNVG) then {_hasNVG = true}};
};
