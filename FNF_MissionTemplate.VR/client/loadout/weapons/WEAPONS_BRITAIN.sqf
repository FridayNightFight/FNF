...
phx_loadout_rifle_mag = "fow_10Rnd_303:14";
...
if (pRole == ROLE_PL || pROLE == ROLE_SL) then {
  ...
  phx_loadout_rifle_mag_tracer = "";
  phx_loadout_rifle_mag = "fow_32Rnd_9x19_sten:7";
};

if (pRole == ROLE_AR) then {
  phx_loadout_rifle_weapon = "fow_w_bren";
  phx_loadout_rifle_mag = "fow_30Rnd_303_bren:13";
};
if (pRole == ROLE_MG) then {
  phx_loadout_rifle_weapon = "fow_w_bren";
  phx_loadout_rifle_mag = "fow_30Rnd_303_bren:18";
};

//Magazine classnames for assistant AR and MMG ammo man roles
phx_loadout_aar_mag = "fow_30Rnd_303_bren:5";
phx_loadout_am_mag = "fow_30Rnd_303_bren:9";
...
switch (pRole) do {
  ...
  case ROLE_CE: {phx_loadout_rifle_mag = "fow_10Rnd_303:10"}; //Combat engineer
  ...
  case ROLE_CR: {phx_loadout_rifle_mag = "fow_10Rnd_303:13"}; //Crewman
  case ROLE_MK: {
