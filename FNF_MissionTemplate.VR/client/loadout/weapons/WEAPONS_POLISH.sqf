...
phx_loadout_rifle_mag = "LIB_5Rnd_762x54:14";
...
if (pRole == ROLE_AR) then {
  ...
  phx_loadout_rifle_mag = "LIB_63Rnd_762x54:7";
};
...
phx_loadout_aar_mag = "LIB_63Rnd_762x54:5";
...
switch (pRole) do {
  ...
  case ROLE_CE: {phx_loadout_rifle_mag = "LIB_5Rnd_762x54:10"}; //Combat engineer
