...
phx_loadout_vest = selectRandom ["V_PlateCarrierIA1_dgtl", "V_Chestrig_rgr", "V_TacVest_blk", "V_I_G_resistanceLeader_F", "rhs_6b23", "rhs_6b13_EMR", "rhs_6b23_rifleman", "rhs_6sh92", "rhs_6sh92_vsr", "rhsusf_mbav", "rhsusf_mbav_rifleman", "rhsusf_plateframe_sapi", "rhsgref_6b23_khaki", "rhsgref_chestrig", "rhsgref_chicom", "rhsgref_otv_khaki", "rhsgref_TacVest_ERDL", "rhssaf_vest_md99_digital_rifleman", "rhssaf_vest_md99_woodland", "rhssaf_vest_md98_rifleman"];
phx_loadout_backpack = selectRandom ["B_AssaultPack_cbr", "B_AssaultPack_rgr", "B_FieldPack_cbr", "B_FieldPack_khk", "B_Kitbag_cbr", "B_Kitbag_sgg", "B_Kitbag_rgr", "B_TacticalPack_blk", "B_TacticalPack_oli", "rhs_sidor", "rhs_assault_umbts", "rhssaf_kitbag_md2camo"];
