...
phx_loadout_uniform  = "U_mas_chi_O_sfd1";
phx_loadout_vest     = "V_mas_chi_PlateCarrier_sfd";
phx_loadout_backpack = "O_mas_chi_Kitbag_d";
phx_loadout_headgear = "H_mas_chi_HelmetO_SFd";


if (pRole == ROLE_PL) then { phx_loadout_uniform = "U_mas_chi_O_officerd3";};
...
if (pRole == ROLE_AAR || pRole == ROLE_AM || pRole == ROLE_CE || pRole == ROLE_AAT) then {
  phx_loadout_backpack = "O_mas_chi_Kitbag_d2";
};
