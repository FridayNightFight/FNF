...
if (count phx_selector_optics > 0) then {call phx_fnc_selector_optics};
if (count phx_selector_weapons > 0) then {call phx_fnc_selector_weapons};
if (count phx_selector_explosives > 0 && pRole == ROLE_CE) then {call phx_fnc_selector_charges};
