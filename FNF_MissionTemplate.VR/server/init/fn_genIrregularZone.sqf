fnf_zoneBoundary_boundsLine_marker_1 = createMarker ["fnf_zoneBoundary_boundsLine_1", [0,0,0], -1];
fnf_zoneBoundary_boundsLine_marker_1 setMarkerShape "POLYLINE";
fnf_zoneBoundary_boundsLine_marker_1 setMarkerColor "ColorBLACK";
fnf_zoneBoundary_boundsLine_marker_2 = createMarker ["fnf_zoneBoundary_boundsLine_2", [0,0,0], -1];
fnf_zoneBoundary_boundsLine_marker_2 setMarkerShape "POLYLINE";
fnf_zoneBoundary_boundsLine_marker_2 setMarkerColor "ColorYELLOW";
