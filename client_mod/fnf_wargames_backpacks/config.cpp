...
class cfgVehicles
{
 ...
 class ptv_RadioBag_01_Woodland: B_RadioBag_01_base_F
 {
	maximumLoad = 1000;
 };
 class ptv_RadioBag_01_Desert: B_RadioBag_01_base_F
 {
	maximumLoad = 1000;
 };
 class ptv_DeltaPack_Blk: Bag_Base
 {
	maximumLoad = 1000;
 };
 class ptv_DeltaPack_Rgr: Bag_Base
 {
	maximumLoad = 1000;
 };
 class ptv_DeltaPack_Cbr: Bag_Base
 {
	maximumLoad = 1000;
 };
 class ptv_DeltaPack_Gry: Bag_Base
 {
	maximumLoad = 1000;
 };
 class ptv_DeltaPack_Grn: Bag_Base
 {
	maximumLoad = 1000;
 };
 class ptv_DeltaPack_AFG: Bag_Base
 {
	maximumLoad = 1000;
 };
 class ptv_DeltaPack_Blk_Ask: Bag_Base
 {
	maximumLoad = 1000;
 };
 class ptv_DeltaPack_Rgr_Ask: Bag_Base
 {
	maximumLoad = 1000;
 };
 class ptv_DeltaPack_Cbr_Ask: Bag_Base
 {
	maximumLoad = 1000;
 };
 class ptv_DeltaPack_Gry_Ask: Bag_Base
 {
	maximumLoad = 1000;
 };
 class ptv_DeltaPack_Grn_Ask: Bag_Base
 {
	maximumLoad = 1000;
 };
 class ptv_DeltaPack_AFG_Ask: Bag_Base
 {
	maximumLoad = 1000;
 };
 class ptv_DeltaPack_Blk_Med: Bag_Base
 {
	maximumLoad = 1000;
 };
 class ptv_DeltaPack_Rgr_Med: Bag_Base
 {
	maximumLoad = 1000;
 };
 class ptv_DeltaPack_Cbr_Med: Bag_Base
 {
	maximumLoad = 1000;
 };
 class ptv_DeltaPack_Gry_Med: Bag_Base
 {
	maximumLoad = 1000;
 };
 class ptv_DeltaPack_Grn_Med: Bag_Base
 {
	maximumLoad = 1000;
 };
 class ptv_DeltaPack_AFG_Med: Bag_Base
 {
	maximumLoad = 1000;
 };
